...
/**
 * Controller class for the ViewAllRecepies view.
 */

public class ViewAllRecepiesController implements Initializable {

    @FXML
    private TextField recepieNameTextField;

    @FXML
    ComboBox<User> authorComboBox;
    ...
    @FXML
    TableColumn<Recept, User> authorTableColumn;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try{
            ...
            recepieList = Database.getRecepies();
    ...
    public void search(){
        ...
        User userToSearch = authorComboBox.getValue();
        ...
        if(userToSearch!=null){
            filteredRecepies = filteredRecepies.stream().filter(recept -> recept.getAuthor().getId().equals(userToSearch.getId())).collect(Collectors.toList());
        }
