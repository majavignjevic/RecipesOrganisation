...
/**
 * Controller class for the NavigationAdmin view.
 */

public class NavigationAdminController implements Initializable {
    @FXML
    ...
    @FXML
    public void allProfiles() throws IOException{
        Run.getFXML("/com/projekt/organizacijarecepata/Controller/profiles.fxml", "All user profiles");
    }
    @FXML
    ...
    @FXML
    public void showChanges() throws IOException{
        Run.getFXML("/com/projekt/organizacijarecepata/Controller/changesInApp.fxml", "Show changes");
    }
